    ...
    <main className="relative w-full overflow-x-hidden overflow-y-auto">
      ...
      >
        ...
        >
          ...
          <div className="mt-12 max-w-4xl mx-auto p-8 rounded-2xl bg-black/40 backdrop-blur-xl border border-purple-700/40 shadow-lg shadow-purple-900/40 text-left space-y-6">

            <h3 className="text-2xl font-bold text-purple-300">Why Kay Karu?</h3>
            ...
            <h3 className="text-xl font-semibold text-purple-300">What does Kay Karu? do?</h3>
            ...
            <h3 className="text-xl font-semibold text-purple-300">Our Mission</h3>
            <p className="text-gray-300 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-purple-300">What makes it unique?</h3>
            <ul className="list-disc list-inside text-gray-300 space-y-1">
            ...
            <h3 className="text-xl font-semibold text-purple-300">Built for You</h3>
            <p className="text-gray-300 leading-relaxed">
